...
if __name__ == '__main__':
    ...
    for cfl in cfls:
        ...
        if color == 'k': 
            ax0.plot(xpos, csolution, label=label_str, color=color,linestyle='--',linewidth=linewidth+2)
        else:
    ...
    ax0.set_title("Computed Solutions for Different CFL at t = 8", fontsize=fs, fontweight=fw)    
