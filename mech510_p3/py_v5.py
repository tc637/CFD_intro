...
if __name__ == '__main__':
    ...
    for each_size in np.arange(0,4):
        ...
        if each_size == 0:
            ...
            ax4.set_title('Contour Plot of the RK2 Solution for the Energy Equation, {} X {}, t = {}'.format(imax,jmax,tmax),
                          fontsize=fs,fontweight=fw)
            ax4.tick_params(axis='both',which='major',labelsize=20)
            cbar.set_label(r'$\overline{T}$',size=fs+5)
            cbar.ax.tick_params(labelsize=20) 
            
            fig_name = 'mech510_p3_rk2_computed.png'
            ...
            fig_name = 'mech510_p3_rk2_ana.png'
            plt.savefig(fig_name, dpi=100, facecolor='w', edgecolor='w',
                orientation='portrait', papertype=None, format=None,
                transparent=False, bbox_inches="tight", pad_inches=0.1,
                frameon=None)
    ...
    ax6.set_title(r'Log-Log Plot of RK2 L$_2$-Norms for Different Mesh Sizes', fontsize=fs, fontweight=fw)
    ax6.tick_params(axis='both',which='major',labelsize=20)
    ax6.set_xlim([0.8,3.0])
    fig_name = 'mech510_p3_rk2_l2.png'
