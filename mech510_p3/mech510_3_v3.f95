...
MODULE meshmod
	...
	!REAL*8, PARAMETER  :: delta_t = 0.0001 ! Time step from stability considerations
    INTEGER, PARAMETER :: maxn = int(tmax/delta_t)    ! Max time step (i.e. last n index)
...
SUBROUTINE rk2(nmin, nmax, tn)                        ! Subroutine for time integration (RK2)
	...
	REAL*8, DIMENSION(1:jmax+1,1:imax)   :: rhsn           ! Right-hand-side of energy equation at time level n
...
SUBROUTINE output_Tmesh(tn) ! Output final solutions for plotting
	...
	! Set filename format
	fmt = "(A8,I0,A6,I0,A6,I0,A3,I0,A4)"  
	
    ! Set filenames
    WRITE(fname, fmt) "Tmesh_cn",imax,"_xmax_",nint(xmax),"_ymax_",nint(ymax),"_t_",nint(tn),".txt"
