...
PROGRAM mech510_3  
	...
	ELSE
		...
		IF (scheme == 1) THEN ! Other problems
...
SUBROUTINE init_mesh_test     ! Initialize mesh with CV average values of T(x,y), u(x,y), v(x,y) and source terms
...
SUBROUTINE init_mesh_channel    ! Initialize mesh with CV average values of T(x,y), u(x,y), v(x,y) and source terms
