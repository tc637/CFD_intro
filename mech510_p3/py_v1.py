...
def read_files(meshsize, xmax, ymax):
    afname = "FI_anal_" + str(meshsize) + "_xmax_" + str(xmax) + "_ymax_" + str(ymax) + ".txt"
    fname = "FI_comp_" + str(meshsize) + "_xmax_" + str(xmax) + "_ymax_" + str(ymax) + ".txt"
...
if __name__ == '__main__':
    ...
    ax1.set_title('Contour Plot of the Computed Flux Integrals for the Energy Equation, Meshsize = {}'.format(meshsizes[0]),
                  fontsize=fs,fontweight=fw)
    ax1.tick_params(axis='both',which='major',labelsize=20)
    cbar.set_label(r'$FI_{computed}$',size=fs+5)
    cbar.ax.tick_params(labelsize=20) 
    
    fig_name = 'mech510_p3_1.png'
    ...
    ax2.set_title('Contour Plot of the Analytic Flux Integrals for the Energy Equation, Meshsize = {}'.format(meshsizes[0]),
                  fontsize=fs,fontweight=fw)
    ax2.tick_params(axis='both',which='major',labelsize=20)
    cbar.set_label(r'$FI_{analytic}$',size=fs+5)
    cbar.ax.tick_params(labelsize=20) 
    
    fig_name = 'mech510_p3_2.png'
    ...
    ax3.set_title('Contour Plot of the Flux Integral Error for the Energy Equation, Meshsize = {}'.format(meshsizes[0]),
                  fontsize=fs,fontweight=fw)
    ax3.tick_params(axis='both',which='major',labelsize=20)
    cbar.set_label(r'$FI_{analytic} - FI_{computed}$',size=fs+5)
    cbar.ax.tick_params(labelsize=20) 
    
    fig_name = 'mech510_p3_3.png'
    ...
    ax4.set_title(r'Log-Log Plot of L$_2$-Norms for Different Mesh Sizes', fontsize=fs, fontweight=fw)
