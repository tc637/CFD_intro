...
MODULE meshmod
    ...
    INTEGER, PARAMETER :: imax = 640                        ! Size of mesh (x-direction)
	INTEGER, PARAMETER :: jmax = 640                       ! Size of mesh (y-direction)
	...
	REAL*8, DIMENSION(0:jmax+1,0:imax+1) :: source_mesh, source_mesh_ana  ! Mesh of sources at time level n (could be interim mesh)
...
SUBROUTINE calc_integrals(Tmeshn)  ! Subroutine to evaluate flux integrals at time level n, with sources
