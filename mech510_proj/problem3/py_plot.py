...
if __name__ == '__main__':
    ...
    file1 = "vmesh_cn10_xmax_1_ymax_1_t_103_p_3_100_0_100.txt"
    dt = 0.5
    xmax = 1
    ymax = 1
    solution = []
    ...
    ax4.set_title(r'Contour Plot of the Steady-State Solution for {}, dt = {}'.format("v",dt),fontsize=fs,fontweight=fw)
