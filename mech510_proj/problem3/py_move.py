...
if __name__ == '__main__':
    ...
    file1 = "pmesh_cn41_xmax_1_ymax_1_t_24_p_3_100_0_100_100.txt"
    dt = 0.5
    xmax = 1
    ymax = 1
    solution = []
    ...
    ax4.set_title(r'Contour Plot of the Steady-State Solution for {}, dt = {}'.format("p",dt),fontsize=fs,fontweight=fw)
